...
<!--[if gte IE 9]>
    ...
    <header>
        ...
        <div id="icons">
            <a href="#" id="to-facebook" rel="nofollow" title="Follow us on Facebook"></a>
            <a href="#" id="to-googleplus" rel="nofollow" title="Follow us on Google+"></a>
            <a href="<?php echo Yii::app()->params->homePath?>/faqs" id="to-faqs" title="Frequently asked quetions"></a>
            <a href="<?php echo Yii::app()->params->homePath?>/contact" id="to-contact" title="Contact us"></a>
        </div><!--END OF ICONS-->
        
        <a id="main-logo" title="MojTrening.sk - Homepage" href="<?php echo Yii::app()->params->homePath.'/'.Yii::app()->language?>"><h1>Môj Tréning .sk</h1></a>
    </header>
